...
namespace Raje.Areas.Identity.Pages.Account
{
    ...
    public class LoginWithRecoveryCodeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Usuário com ID '{UserId}' logged in with a recovery code.", user.Id);
            ...
            {
                _logger.LogWarning("Invalid recovery code entered for Usuário com ID '{UserId}' ", user.Id);
